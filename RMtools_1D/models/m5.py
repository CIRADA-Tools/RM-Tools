...
def model(inParms, lamSqArr_m2):
    """Equation 41 from Sololoff: RM-gradient across the beam."""
...
inParms = [
    ...
    {"parname": "sigmaRM3_radm2",
     "label": "$\sigma_{RM,3}$ (rad m$^{-2}$)",
     "value": 0.0,
     "error": 0.0,
     "fixed": False,
     "seedrng": [0.0, 10.0],
    ...
    {"parname": "DeltaRM1_radm2",
     "label": "$\Delta_{RM,1}$ (rad m$^{-2}$)",
     "value": 0.0,
     "error": 0.0,
     "fixed": False,
     "seedrng": [0.0, 10.0],
    ...
    {"parname": "DeltaRM2_radm2",
     "label": "$\Delta_{RM,2}$ (rad m$^{-2}$)",
     "value": 0.0,
     "error": 0.0,
     "fixed": False,
     "seedrng": [0.0, 10.0],
    ...
    {"parname": "DeltaRM3_radm2",
     "label": "$\Delta_{RM,3}$ (rad m$^{-2}$)",
     "value": 0.0,
     "error": 0.0,
     "fixed": False,
     "seedrng": [0.0, 10.0],
